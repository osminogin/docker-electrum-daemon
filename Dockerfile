...
ARG ELECTRUM_VERSION $VERSION
ARG ELECTRUM_USER electrum
ARG ELECTRUM_PASSWORD electrumz		# XXX: CHANGE REQUIRED!
ARG ELECTRUM_HOME /home/$ELECTRUM_USER
ARG ELECTRUM_NETWORK $ELECTRUM_NETWORK

# IMPORTANT: always verify gpg signature before changing a hash here!
# ENV ELECTRUM_CHECKSUM_SHA512 

RUN apk add openssl-dev libffi-dev python3-dev
